...
minetest.register_alias("homedecor:gate_barbed_wire_open",          "homedecor:fence_barbed_wire_gate_open")
minetest.register_alias("homedecor:gate_barbed_wire_closed",        "homedecor:fence_barbed_wire_gate_closed")
minetest.register_alias("homedecor:gate_chainlink_open",            "homedecor:fence_chainlink_gate_open")
minetest.register_alias("homedecor:gate_chainlink_closed",          "homedecor:fence_chainlink_gate_closed")
minetest.register_alias("homedecor:gate_picket_open",               "homedecor:fence_picket_gate_open")
minetest.register_alias("homedecor:gate_picket_closed",             "homedecor:fence_picket_gate_closed")
minetest.register_alias("homedecor:gate_picket_white_open",         "homedecor:fence_picket_gate_white_open")
minetest.register_alias("homedecor:gate_picket_white_closed",       "homedecor:fence_picket_gate_white_closed")
